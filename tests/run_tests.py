...
def run_phone_number_tests():
    ...
    phone_number_tests_result = pytest.main(
        ["tests/test_phone_numbers.py", "-v", "--tb=short", "-s"]
...
def run_email_tests():
    ...
    email_tests_result = pytest.main(
        ["tests/test_emails.py", "-v", "--tb=short", "-s"]
    )  # Verbose mode with short traceback
...
def run_iban_and_swift_tests():
    ...
    iban_tests_result = pytest.main(
        ["tests/test_iban_validation.py", "-v", "--tb=short", "-s"]
    )  # Verbose mode with short traceback
